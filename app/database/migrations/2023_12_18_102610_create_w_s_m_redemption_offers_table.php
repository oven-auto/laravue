...
class CreateWSMRedemptionOffersTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wsm_redemption_offers', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('wsm_redemption_offers');
    }
}
