        ...
        switch ($action) {
            ...
            case 'store':
                if($userPermissons->contains('slug', 'cevent_add'))
                    return $next($request);
                throw new \Exception('Отсутствуют права: '.\App\Models\Permission::where('slug','cevent_add')->first()->name);
            ...
            case 'index':
                if($userPermissons->contains('slug', 'cevent_list'))
                    ...
                    throw new \Exception('Отсутствуют права: '.\App\Models\Permission::where('slug','cevent_list')->first()->name);
