...
class ReserveException extends Exception
{
    private const ERRORS = [
        ...
        'empty_client_data'             => 'В Вашей сделке, Вы дошли до заключения договора, однако у Вашего клиента не заполнены важные поля (ФИО/Компания, Зона контакта, Пол). Перейдите во вкладку клиент и дополните данные.',
        ...
        'contract_on_invoice'           => 'ПДКП нельзя оформить на автомобиль из наличия.',
